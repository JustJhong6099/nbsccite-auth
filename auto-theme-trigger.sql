-- ================================================================
-- AUTO-ASSIGN THEMES TRIGGER
-- Automatically assigns research themes when abstract is approved
-- Uses AFTER trigger to avoid conflicts with other column constraints
-- ================================================================

-- Function to auto-assign themes based on title keywords
...
-- Create AFTER trigger to avoid constraint conflicts
...
-- Test: This should automatically assign themes
-- (Try approving an abstract through the UI to test)

SELECT 'Auto-assign themes trigger created successfully!' as status;
